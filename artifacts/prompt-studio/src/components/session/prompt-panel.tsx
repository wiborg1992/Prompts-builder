...
export function PromptPanel({ sessionId, onPromptGenerated, forcedSelectedId }: PromptPanelProps) {
  ...
  const resolvedId = forcedSelectedId ?? selectedId ?? sortedPrompts[0]?.id ?? null;
